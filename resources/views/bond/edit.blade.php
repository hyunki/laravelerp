...
@section('title', '지급보증수정'.$bond->LgNumber)
@section('content')
...
@include('partials._messages')
    ...
    {!! Form::model($bond, ['route' => ['bond.update' , $bond->id]]) !!}
        ...
        <div class="form-group form-inline">
        <label for="Validity">은행반납:</label>
        
        {!! Form::checkbox('Validity', 1, isset($bond->Validity) ? $bond->Validity['check'] : 0, []) !!}
...
$('.typeahead').typeahead({
  ...
  name: 'projectName',
  limit: 10,
  source: substringMatcher(guarantee_type)
});
